...
Postgres database need a bit more set up, I will get to that eventually. If you **_minikube delete_** all data will be lost. If you would like to persist data on your machine
...
Emails need to be unique: Password is **_12345_**
...
## Some Stuff for Junior

If you have to set up minikube and skaffold a lot, there are a couple of dead docker images created. You may run into disk space isses.
Just use this to clean up all the unused images and press 'y' to confirm:

```
minikube ssh -- docker system prune
```

Or just delete the useless shit on the machine and install Linux over the whole device dumbass...

---

Sometimes when you restart your machine you might have to run the pod_deploys shell script again
