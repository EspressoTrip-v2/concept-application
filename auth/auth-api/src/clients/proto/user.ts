...
export interface ProtoGrpcType {
  userPackage: {
    AllUsers: MessageTypeDefinition
    CreateUserInfo: MessageTypeDefinition
    GitHubUser: MessageTypeDefinition
    GoogleUser: MessageTypeDefinition
    LocalUser: MessageTypeDefinition
