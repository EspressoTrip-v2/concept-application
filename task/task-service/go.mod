...
require (
	github.com/EspressoTrip-v2/concept-go-common v1.0.63
...
require (
	...
	go.opentelemetry.io/contrib/instrumentation/go.mongodb.org/mongo-driver/mongo/otelmongo v0.30.0 // indirect
