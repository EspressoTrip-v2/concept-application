...
import type {
    AnalyticServiceClient as _analyticsPackage_AnalyticServiceClient,
    AnalyticServiceDefinition as _analyticsPackage_AnalyticServiceDefinition,
} from "./analyticsPackage/AnalyticService";
