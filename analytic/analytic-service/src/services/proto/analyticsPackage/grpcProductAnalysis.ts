...
import type {
    grpcProductBreakDown as _analyticsPackage_grpcProductBreakDown,
    grpcProductBreakDown__Output as _analyticsPackage_grpcProductBreakDown__Output,
} from "../analyticsPackage/grpcProductBreakDown";
